...
public class Transmitter {
    ...
    private static RTPManager[] messageRTP;
    ...
    private String createTransmitter() {
        ...
        for (int i = 0; i < pbss.length; i++) {
            try {
                ...
                portLocal = this.port + 2 * i;
                ipAddr = InetAddress.getByName(hostAddress);
                localAddr = new SessionAddress(InetAddress.getLocalHost(), portLocal);
                destAddr = new SessionAddress(ipAddr, portLocal);
                ...
                Player player = null;
                try {
                    player = Manager.createRealizedPlayer(dataSource);//mediaLocator);
